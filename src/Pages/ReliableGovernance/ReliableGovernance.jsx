...
const ReliableGovernance = () => {
  return (
    <div className="w-[84%] m-auto">
      <h4 className="font-semibold my-5 text-2xl text-navy">
        Reliable governance for responsible value creation
      </h4>
      <img className="object-contain w-[80%]" src="./Risk/aman1.jpg" alt="" />
      <img className="object-contain w-[90%]" src="./Risk/aman2.jpg" alt="" />
      {/* <img src="./Risk/rdb.png" alt="" /> */}
      <h4 className="font-semibold my-5 text-xl text-navy">
        Our core governing policies
      </h4>
      <img src="./Risk/Screenshot 2024-07-03 at 1.26.36 PM.png" alt="" />
      <h4 className="font-semibold my-5 text-xl text-navy">
      ...
      <div className="flex flex-wrap justify-between align-start gap-8">
        <div className="w-full md:w-[28%] ">
          <p>
            The Tata Code of Conduct (‘TCOC’) is the foundation that governs the
            behaviour and operations of Tata Communications. The TCOC embodies a
            set of core values and principles that are crucial to the way we
            conduct our business. It serves as a comprehensive guide for our
            employees, as well as our partners, customers, suppliers, and third
            parties, ensuring that everyone associated with the Company adheres
            to the highest standards of ethical conduct.
            <br />
            The TCOC sets out the guidelines and creates a living framework that
            influences our daily operations and strategic decisions. The core
            values and principles enshrined in the TCOC translate into codified
            policies and practical procedures within the organisation to ensure
            shared commitment to the core values. It guides our business
            practices to be transparent, accountable and aligned with our
            dedication to the highest ethical standards. This includes
            maintaining integrity, respecting human rights, and fostering an
            inclusive and dignified workplace.
          </p>
        </div>
        <div className="w-full md:w-[68%]  mr-2">
          <h4 className="font-semibold text-blue my-5 mt-0 text-xl">
            Implementation and enforcement of the TCOC
          </h4>
          <h4 className="font-semibold my-5 text-xl text-navy">
            E-Learning and Certification
          </h4>
          <p>
            We have implemented a mandatory web- based e-learning module on the
            TCOC for all employees, which requires annual re-certification. This
            training is also part of the onboarding process for new employees,
            who are inducted into the Company. The module includes an assessment
            to test employees’ understanding of the TCOC, culminating in a
            certification that enables them to uphold the desired standards.
          </p>
          <h4 className="font-semibold my-5 text-xl text-navy">
            Diverse Training Methods
          </h4>
          <p>
            Beyond the e-learning modules, the Legal Compliance team conducts
            extensive company-wide live training sessions. These sessions
            encompass various policies which derive their essence from the TCOC
            and ensure that all employees, fully understand and can practically
            apply these policies in their routine work.
          </p>
          <h4 className="font-semibold my-5 text-xl text-navy">
            Living the Code Initiative
          </h4>
          <p>
            In FY24, a company- wide ‘Living the Code’ initiative was propagated
            wherein employees were encouraged to share personal testimonials
            about how they have embraced and implemented the Tata Code of
            Conduct in their lives. This initiative focussed on celebrating our
            commitment to ethics and inspiring others to emulate similar
            practices.
          </p>
        </div>
      </div>
